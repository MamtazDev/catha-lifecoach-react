...
const ProtectData = () => {
  ...
  return (
    ...
    <section className="imprint">
      ...
      <div className="container ">
        <div className="mb-5">
          <h2 className="mt-3 mb-3 mt-lg-5 mb-lg-5">Datenschutzerklärung</h2>
          ...
          <div className="d-flex flex-column gap-3 mb-5">
            ...
            <div className="mb-2">
              <p>Catharina Rettieck-Süfke Life Coach</p>
              <p>Rhiemsweg 12</p>
              <p>22111 Hamburg </p>
              <p>Telefon: 0176 82010686 </p>
              <p>E-Mail: kontakt@rettieck-suefke-coaching.de</p>
            </div>
        ...
        <div className="next_btn d-flex justify-content-between align-items-center mb-5">
          <Link to="/contact">
            {" "}
            <button>
